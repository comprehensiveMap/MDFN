...
class FuseLayer(nn.Module):
    ...
    def forward(self, input1, input2):
        fuse_prob = self.gate(self.linear(torch.cat([input1, input2], dim = -1)))
...
class ElectraForMultipleChoicePlus(ElectraPreTrainedModel):
    ...
    def forward(
        ...
        context_word_level = self.fuse1(local_word_level, global_word_level)
        sa_word_level = self.fuse2(sa_self_word_level, sa_cross_word_level)
